...
public class SingleMedication extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.single_medication);

        String id = getIntent().getStringExtra("id");

        mProgress = new ProgressDialog(SingleMedication.this);
        ...
        new JSONTask().execute("http://myagrapalace.com/ttm/json-medication-single.php?id="+id+"&&user="+savedUser);
        //new JSONTask().execute("http://192.168.0.102/ttm/json-medication-single.php?id="+id+"&&user="+savedUser);
    ...
    public class JSONTask extends AsyncTask<String,String,String>{
        ...
        protected void onPostExecute(String s) {
            ...
            myList.setAdapter(new ArrayAdapter<String>(SingleMedication.this,android.R.layout.simple_list_item_1,patientList));
        }
    }
}
